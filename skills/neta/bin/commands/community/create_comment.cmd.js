...
export const createCommentCmd = createCommand({
    ...
    inputSchema: z.object({
        ...
        parent_type: z
            ...
            .describe("父级对象类型：collection-作品，character-角色，elementum-元素"),
        at_users: z
            .string()
            .optional()
            .default("")
            .describe("@的用户 UUID 列表，使用逗号分隔（可选，例如：uuid1,uuid2,uuid3）"),
    }),
    ...
    log.info("create_comment: 对%s %s 发布评论：%s", parent_type, parent_uuid, content);
    // 将逗号分隔的字符串转换为数组
